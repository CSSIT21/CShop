...
import { Avatar, Typography, Modal,Box } from "@mui/material";

import config from "~/common/constants";
import axios from "axios";
import { useParams } from "react-router-dom";

const EventPromotionBody = ({ columns }) => {
  ...
  const fetchStock = async () => {
    try {
      const res = await axios.get(
        `${config.SERVER_URL}/sellerconsole/14/myCoupon`
      );
...
export default EventPromotionBody;
